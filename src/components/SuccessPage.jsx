...
function SuccessPage({ onBack }) {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-white dark:bg-[#111216]">
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#111216] py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        {/* Success Card */}
        <div className="bg-white dark:bg-[#111216] rounded-xl border border-gray-200 dark:border-[#3e3e42] shadow-2xl p-8 space-y-6">
          {/* Header */}
          <div className="text-center">
          ...
          {/* Transaction Hash */}
          <div className="bg-gray-50 dark:bg-[#111216] rounded-lg p-4 space-y-2 border border-gray-200 dark:border-[#3e3e42]">
          ...
          {/* Info */}
            <div className="pt-4 border-t border-gray-200 dark:border-[#3e3e42]">
